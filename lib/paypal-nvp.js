...
var SANDBOX_API_HOST    = 'api-3t.sandbox.paypal.com';
// Paypal Production API host
var PRODUCTION_API_HOST = 'api-3t.paypal.com';
// Paypal API version
var API_VERSION         = '97.0';

// constructor
var paypal_nvp = exports.Paypal_Nvp = function( username, password, signature ) {
...
// cb - function - callback
//
// sets data.METHOD to CreateRecurringPaymentsProfile and
// calls internal request function 
paypal_nvp.prototype.create_recurring_payment = function( data, cb ) {
...
// cb - function - callback
//
// sets data.METHOD to GetRecurringPaymentsProfileDetails and
// calls internal request function
paypal_nvp.prototype.get_subscription_details = function( data, cb ) {
	if ( typeof cb === 'undefined' ) {
		throw new Error( 'Callback is required' );
	}
